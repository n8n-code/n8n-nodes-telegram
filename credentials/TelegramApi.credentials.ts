...
export class TelegramApi implements ICredentialType {
	...
	icon: Icon = { light: 'file:../nodes/Telegram/telegram.svg', dark: 'file:../nodes/Telegram/telegram.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			default: '',
			required: true,
			placeholder: 'https://api.telegram.org/bot123456:ABC-DEF1234ghIkl-zyx57W2v1u123ew11',
			description: 'The base URL of your telegram API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
